	...
	public void actionPerformed(ActionEvent ev) {
		if (ev.getSource().equals(btnAdd)){
			...
			if (type=="Tornado"){
				...
				JOptionPane.showMessageDialog(null, "Wrong Storm type(has to be Tornado/Hurricane/Blizzard. Current is -"+type);
			}
		}
		...
		else if(ev.getSource().equals(btnView)){
			String name = txt_StormName.getText();
			if (AdvCentre.getStorm(name)!=null){
				JOptionPane.showMessageDialog(null, "Name: "+AdvCentre.getStorm(name).getName()+" Classification: "+AdvCentre.getStorm(name).getClassification()+" Advice: "+AdvCentre.getStorm(name).getAdvice());
				txt_StormName.setText("");
				txt_WindSpeed.setText("");
				txt_Temperature.setText("");
				txt_Type.setText("");	
